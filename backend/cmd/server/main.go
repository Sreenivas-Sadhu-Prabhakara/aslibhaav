// Command server runs the Aslibhaav HTTP middleware.
package main
...
import (
	...
	"github.com/Sreenivas-Sadhu-Prabhakara/aslibhaav/backend"
)

func main() {
	var store backend.HistoryStore
	...
	log.Printf("aslibhaav listening on %s", addr)
